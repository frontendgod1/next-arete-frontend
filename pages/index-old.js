      ...
      <Container>
        <Row className="align-items-center">
          <Col lg='6'>
            ...
            <Link href="https://arete-sport-shop.myshopify.com/collections/movember-collection#shopify-section-movember-rich-text-2"><a className="btn btn-dark text-uppercase"><img className="me-2 d-inline" src="/images/movember-small.png" />Shop Movember</a></Link>
            <Link href="/movember"><a className="btn btn-light text-uppercase">Learn About Movember</a></Link>
            </div>    
          </Col>
          <Col lg='6'>
    ...
    <section className=" bg-primary sport-management-small">
      <Container className="py-4">
        <Row className="align-items-center">
          ...
          <Col lg='2'>
            <Link href="/sport-management"><a className="btn btn-outline-light w-100">Read More</a></Link>
          </Col>
        </Row>
      </Container>
    </section>
